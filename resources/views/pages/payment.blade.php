                           ...
                           <div class="form-group">
                                <ul class="logos_list " >
                                    <li>
                                        ...
                                        <label for="stripe">
                                            <img src="{{ asset('frontend/images/mastercard.png') }}" style="width: 100px; height: 60px;">
                                        </label>
                                    </li>
                                    <li>
                                        <input type="radio" name="payment" value="paypal" id="paypal">
                                        <label for="paypal">
                                            <img src="{{ asset('frontend/images/paypal.png') }}" style="width: 100px;">
                                        </label>
                                    </li>
                                    <li>
                                        <input type="radio" name="payment" value="ideal" id="ideal">
                                        <label for="ideal">
                                            <img src="{{ asset('frontend/images/mollie.png') }}" style="width: 100px; height: 80px;">
                                        </label>
                                    </li>
                                 </ul>
                            </div><br>
